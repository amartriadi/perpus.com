...
@section('register')
    <div class="boxRegis shadow m-auto mt-5 rounded-3 container">
        <div class="d-flex pt-2">
            <div class=" d-block col-3 justify-content-center align-items-start col-6">
            ...
            <form action="" class="bg-transparent py-5 col-4">
                <input type="email" class="formRegister d-block m-auto rounded-3 p-1 mb-4" id="email" placeholder="Email">
                <input type="password" class="formRegister d-block m-auto rounded-3 p-1 mt-4 mb-2" id="password"
